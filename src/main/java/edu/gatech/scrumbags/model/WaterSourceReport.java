...
public class WaterSourceReport extends WaterReport {
	 ...
	 */
	public WaterSourceReport (WaterLocation location, Date sourceReportDate, WaterType sourceType,
	...
	public String toString () {
		return super.toString() + ", Type: " + getSourceTypeDescription() + ", Condition: "
