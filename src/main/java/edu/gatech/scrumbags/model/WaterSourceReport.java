...
public class WaterSourceReport {
	...
	public WaterSourceReport (WaterLocation location, WaterType sourceDescription, WaterCondition sourceCondition,
		String submitterName) {
		this(location, sourceDescription, sourceCondition, submitterName, new Date());
	}

	public WaterSourceReport (WaterLocation location, WaterType waterSourceType, WaterCondition sourceCondition,
		String submitterName, Date sourceReportDate) {
	...
	public String toString () {
		return getSourceTypeDescription() + ", " + getSourceConditionDescription();
	}
}
