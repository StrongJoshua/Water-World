...
public class HistoricalReportController {
	 ...
	 * Checks that something is chosen for yearComboBox.
	 */
	@FXML public void handleSubmitPressed () {
		if (yearComboBox.getValue() == null) {
			...
			MainFXApplication.setLastUsedHistoricalReport(
				new HistoricalReport(MainFXApplication.getLastUsedSourceReport(), HistoricalType.Virus,
			...
			MainFXApplication.setLastUsedHistoricalReport(
				new HistoricalReport(MainFXApplication.getLastUsedSourceReport(), HistoricalType.Contaminant,
					yearComboBox.getValue()));
			MainFXApplication.loadScene(MainFXApplication.Scenes.historicalReportGraph);
		}
	}
