...
public class HistoricalReportController {
    ...
    /** Handles the input verification when the user presses the submit button. Checks that something is chosen for
     * yearComboBox. */
    @FXML
    public void handleSubmitPressed () {
        if (yearComboBox.getValue() == null) {
            ...
            MainFXApplication.setLastUsedHistoricalReport(
                new HistoricalReport(MainFXApplication.getLastUsedSourceReport(), HistoricalType.Virus, yearComboBox.getValue()));
            ...
            MainFXApplication.setLastUsedHistoricalReport(new HistoricalReport(MainFXApplication.getLastUsedSourceReport(),
                HistoricalType.Contaminant, yearComboBox.getValue()));
            MainFXApplication.loadScene(MainFXApplication.Scenes.historicalReportGraph);
        }
    }
